...
const {
  ...
  setLdapSettings,
  testLdapSettings,
  getLdapCorrespondences,
  setLdapCorrespondence,
...
//SK ROUTE A RENOMMER
adminRouter.put(
  "/monitoring/burning/options",
  [userAuthMidelware, userAdminMidelware],
  updateRobotOptions
);

// PadiMedical Settings routes
adminRouter.get(
  "/options/orthanc",
  [userAuthMidelware, userAdminMidelware],
  getOrthancServer
...
//PadiMedical Task routes
adminRouter.post(
  "/tasks/retrieve/:id/validate",
  [userAuthMidelware, userAdminMidelware],
  validateRetrieve
);
adminRouter.get(
...
adminRouter.get(
  "/users/labels/:label",
  [userAuthMidelware, roleAccessLabelMidelware],
  getLabelRoles
);
adminRouter.get(
  "/users/:name/roles/:role_name/labels",
  [userAuthMidelware],
  getRoleLabels
);
adminRouter.post(
  "/users/:name/labels/:name",
  [userAuthMidelware, userAdminMidelware],
  createRoleLabel
);
adminRouter.delete(
...
adminRouter.post(
  "/patient/:id/studies/:uid/labels/:name",
  [userAuthMidelware, userAdminMidelware],
  createStudyLabel
);
adminRouter.delete(
  "/studies/:uid/labels/:name",
  [userAuthMidelware, userAdminMidelware],
  deleteStudyLabel
);
