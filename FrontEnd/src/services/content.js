...
const orthancContent = {
    ...
    getReportStatusByID(IDS=[]){
        const Options = {
          ...
          return fetch("/api/report-status-by-ids", Options).then((response) => {
            if (!response.ok) {throw response}
            return response.json()
            }).catch((error) => {
                throw(error)
    ...
    syncStudieIdWithReport(old_id,new_id){
        ...
        return fetch('/api/report/sync/single', options ).then((response) => {
            if (!response.ok) {throw response}
            return response.json()
        }).catch((error) => {
            toast.error(error)
    ...
    syncStudieIdWithReportBulk(old_data,new_ids){
        ...
        const options = {
            ...
            body:JSON.stringify({old_data,new_ids})
        }

        return fetch('/api/report/sync/bulk', options ).then((response) => {
            if (!response.ok) {throw response}
            return response.json()
        }).catch((error) => {
            toast.error(error)
