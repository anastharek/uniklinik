...
export default class ModalCardShareButtonWSI extends Component {
  state = {
    doc: null,
    expiry:'year',
    duration:100,
  ...
  constructor(props) {
    super(props);
    this.ViewLink = `${window.location.protocol}//${window.location.host}/external/wsi/`; //changes made by rishabh (25-05-2022)
  }
  ...
  generateCard = async () => {
    ...
    // this.addWrappedText({
    //   url: `${this.DownloadLink}${this.props.StudyInstanceUID}---${this.props.orthancID}`, //change by rishabh 3.3.2023
