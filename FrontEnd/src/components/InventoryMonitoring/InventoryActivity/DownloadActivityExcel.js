...
const DownloadActivityExcel = ({data}) => {
    return (
      <ExcelFile
        element={
          <button
      ...
      >
        <ExcelSheet data={data} name="Users">
          <ExcelColumn label="Activity" value="activity_type" />
          <ExcelColumn label="User" value={col=>col?.User?.username} />
...
export default DownloadActivityExcel;