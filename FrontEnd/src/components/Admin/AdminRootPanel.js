...
import AISeriesConf from "./AISeriesConf/AISeriesConf";
import AiAutoRouter from "./AiAutorouter/AiAutorouter";
          ...
          <nav className="d-flex flex-column text-justify justify-content-start align-items-center">
            ...
            <Nav className="me-auto mb-3 d-flex align-items-center">
              <button
                id="icoUser"
                type="button"
                value="ai-series-configuration"
                className={
                  "sub-btn-admin" +
                  (selectedOptionMenu === "ai-series-configuration"
                    ? " sub-btn-admin-active"
                    : "")
                }
                onClick={clickHandler}
              >
                <i className="fas fa-arrow-circle-right pe-2"></i>Ai Series Conf.
              </button>
            </Nav>
            {roles.manage_auto_send_ai &&
            <Nav className="me-auto mb-3 d-flex align-items-center">
              <button
                id="icoUser"
                type="button"
                ...
                className={
                  "sub-btn-admin" +
                  (selectedOptionMenu === "ai-autorouter"
                    ? " sub-btn-admin-active"
                    : "")
                }
                onClick={clickHandler}
              >
                <i className="fas fa-arrow-circle-right pe-2"></i>Ai Autorouter
              </button>
            </Nav>}
            {!is_moderator && (
              <>
                <Nav
                  hidden={is_moderator}
                  className="me-auto mb-3 d-flex align-items-center"
                >
                  <button
                    id="icoAets"
                    type="button"
                ...
                >
                  <button
                    ...
                    className={
                      "sub-btn-admin" +
                      (selectedOptionMenu === "External Endpoints"
                        ? " sub-btn-admin-active"
                        : "")
                    }
                    onClick={clickHandler}
                  >
                    <i className="fas fa-arrow-circle-right pe-2"></i>External
                    Endpoints
                  </button>
                </Nav>
                <Nav
                ...
                >
                  <button
                    ...
                    className={
                      "sub-btn-admin" +
                      (selectedOptionMenu === "Robots & Tasks"
                        ? " sub-btn-admin-active"
                        : "")
                    }
                    onClick={clickHandler}
                  >
                    <i className="fas fa-arrow-circle-right pe-2"></i>Robots &
                    Tasks
                  </button>
                </Nav>
                <Nav
