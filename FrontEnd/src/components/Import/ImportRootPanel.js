      ...
      <div className='mb-5'>
        <Row className="pb-3">
          <Col className="d-flex justify-content-start align-items-center">
              <i className="fas fa-file-import ico me-3"></i><h2 className="card-title">Upload DICOM</h2> {/*tukar nama - Import Dicom to Upload DICOM , Create DICOM to DICOM Converter*/}
          </Col>
        </Row>
