        ...
        return (
            <Dropdown as={ButtonGroup} onClick={this.handleClick}>
                ...
                <Dropdown.Menu className="mt-2 border border-dark border-2">
                    <Dropdown.Item className='bg-orange' onClick={this.sendToExportList}>Export List</Dropdown.Item>
                    <Dropdown.Divider />
                    <Dropdown.Item className='bg-blue' onClick={this.sendToAnonList}>Anonymize List</Dropdown.Item>
                    <Dropdown.Divider />
                    <Dropdown.Item className='bg-reddel' onClick={this.sendToDeleteList}>Delete List</Dropdown.Item>
                </Dropdown.Menu>
            </Dropdown>
        )
    }
