...
const toolbarButtons: Button[] = [
  ...
  },
  {
    ...
    props: {
      ...
      label: i18n.t('Buttons:Annotation Style'),
      tooltip: i18n.t('Buttons:Pick annotation color and line thickness'),
      commands: 'openAnnotationStyleDialog',
      evaluate: 'evaluate.action',
    },
  },
  {
    ...
    props: {
      ...
      commands: 'captureViewportToDicom',
      evaluate: [
        'evaluate.action',
        {
          name: 'evaluate.viewport.supported',
...
export const toolbarSections = {
  [TOOLBAR_SECTIONS.primary]: [
    ...
    'TrackballRotate',
    'WindowLevel',
    // PUTRACNS (2026-08-25): Stack Scroll promoted from the MoreTools dropdown
    // to sit directly beside Windowing — the two most-used viewing controls,
    // especially on mobile. Same button definition as before (icon, command,
    // active-state all unchanged); only its toolbar position moved.
    'StackScroll',
    // PUTRACNS (2026-08-25): annotation tools promoted to the primary toolbar
    // (they previously lived only inside the MeasurementTools dropdown, which
    // was easy to miss on mobile): arrow, rectangle, ellipse, freehand draw
    // (paint-brush style) + the color / thickness picker for annotations.
    'ArrowAnnotate',
    'RectangleROI',
    'EllipticalROI',
    'PlanarFreehandROI',
  ...
  MoreTools: [
    ...
    'ReferenceLines',
    'ImageOverlayViewer',
    // StackScroll removed 2026-08-25 — promoted to the primary toolbar next
    // to WindowLevel. The underlying tool is unchanged (still registered).
    'invert',
    'Probe',
    'Cine',
    'Angle',
