...
class ToolbarRow extends Component {
  ...
  componentDidMount() {
    ...
    let timer1 = setInterval(() => {
      let prediction = document.querySelector('.pull-right .RoundedButtonGroup  .roundedButtonWrapper:nth-child(2)')
      if (prediction) {
        clearInterval(timer1)
        prediction.style.display = 'none'
        var timer;
        timer = setInterval(() => {
          let element = document.querySelector('div[data-cy=padi-ai]')
  ...
  render() {
    console.log(this.buttonGroups.right)
    console.log(this.props.selectedRightSidePanel)
